    ...
    <div className='absolute top left' style={{ width: '100%', height: '100%' }}>
      <article className='padding absolute center middle' style={{ width: '70%', height: '70%', display: 'flex', flexDirection: 'row' }} >
        ...
        <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', textAlign: 'center', flex: 1, gap: '10%'}}>
          ...
          <h4 style={{width: '60%'}}>
            When the Blood Moon rose and refused to wane, the veil twixt Heaven and Hell was sundered. Through long forgotten portals, angels and demons alike now tread upon mortal soil and their endless war rekindled beneath crimson skies. Amidst the ruin of men, only those who endure the night may glimpse the dawn.
          </h4>
